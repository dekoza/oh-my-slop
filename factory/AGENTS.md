...
[`docs/specs/software-factory.md`](../docs/specs/software-factory.md) is the authority; cite the
section a change answers to.

Every path below is spelled relative to the repository root.

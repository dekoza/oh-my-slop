...
§8.2's checks passed at, so the review, the checks, and the publication measure one value
(§14.13). A walking attempt's **own** base (§7.3) is the prior attempt's tip for a repair

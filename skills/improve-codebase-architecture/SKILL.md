...
Once the user picks a candidate, conduct a specification interview to walk the design tree with them — constraints, dependencies, the shape of the deepened module, what sits behind the seam, what tests survive.

Use the [`court-jester`](../court-jester/SKILL.md) skill for adversarial review of the proposed deepening, or conduct a collaborative specification interview.

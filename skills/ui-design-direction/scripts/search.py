...
Domains: style, icons, color, chart, landing, product, ux, typography, react, web
...
if __name__ == "__main__":
    ...
    parser.add_argument("--stack", "-s", choices=AVAILABLE_STACKS, help="Stack-specific search for a supported frontend stack")

...
6. **Protect exact and risky content.** Safety warnings use normal, explicit sentences. For every proposed or requested destructive action, name the permanent loss, state whether it is irreversible, and name the recovery prerequisite before giving or discussing its command. Preserve code, quotations, required legal wording, and external text exactly where accuracy requires it.

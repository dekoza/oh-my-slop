...
| WebSockets | `hx-ext="ws"` | Extension. No custom `WebSocket` client code. See [extensions](skills/htmx/references/extensions.md). |
...
**Full API reference:** See the [`htmx` skill](skills/htmx/SKILL.md) and its reference files for complete attribute docs, swap methods, events, extensions, patterns, and gotchas.
